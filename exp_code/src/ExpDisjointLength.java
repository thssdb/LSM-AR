...
public class ExpDisjointLength {
    ...
    public static void main(String[] args) throws IoTDBConnectionException, StatementExecutionException {
        ...
        for (int index = 0; index < 6; index ++) {
            ...
            int iterNum = 10;
            LogWriter lw = new LogWriter("./result/ExpDisjointLength/UDF/" + curDataset + "_res.dat");
            lw.open();
            ...
            iterNum = 30;
            lw = new LogWriter("./result/ExpDisjointLength/TsFile/" + curDataset + "_res.dat");
            lw.open();
            lw.log("Length\tTimeCost" + "\n");
